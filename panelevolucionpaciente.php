...
$alimentos = [];
$sqlAli = 'SELECT fecha, tipo_comida, descripcion, hora, foto_path FROM alimentos_registro WHERE paciente_id = ? ORDER BY fecha DESC, hora DESC LIMIT 15';
if (!($stmtAli = @$conexion->prepare($sqlAli))) {
